		...
		*/
		...
		public void run(){
			 ...
			 while(flag){
					...
					word1.setX(random.nextInt(300));
					word1.setY(random.nextInt(300));

					word2.setX(random.nextInt(300));
					word2.setY(random.nextInt(300));

					word3.setX(random.nextInt(300));
					word3.setY(random.nextInt(300));

					word4.setX(random.nextInt(300));
					word4.setY(random.nextInt(300));

					word5.setX(random.nextInt(300));
					word5.setY(random.nextInt(300));
